  ...
  map.on('click',
                function(e){
                    ...
                    var content = "<form  name=\"marker\" id=\"markerForm\" method=\"post\">"+
                                  ...
                                  "<br><label>Reimbursement</label>"+"      <input type=\"text\" value=1 id=\"Reimbursement\" name=\"Reimbursement\" size=\"8\" required>"+
                                  "<br><label>System Panel Modules</label>"+"     <input type=\"text\" value=1 id=\"Panel_Modules\" name=\"Panel_Modules\" size=\"15\" required>"+
                                  "<br><label>Azimuth Angle</label>"+"          <input type=\"text\" value=1 id=\"Azimuth\" name=\"Azimuth\" size=\"12\" required>"+
                                  "<br><label>Inclination Angle</label>"+"       <input type=\"text\" value=1 id=\"Inclination_Angle\" name=\"Inclination_Angle\" size=\"20\" required>"+
