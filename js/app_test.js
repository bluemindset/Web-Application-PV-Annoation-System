  ...
  map.on('click',
                function(e){
                    ...
                    var content = "<div id=\"result\"</div><form  name=\"marker\" id=\"markerForm\" method=\"post\">"+
                                  "<label>Name</label> "+"  <input type=\"text\" value=\"Enter Name:\" id=\"Name\" name=\"Name\" required>"+
                                  ...
                                  "<br><label>Annual Production</label>"+"      <input type=\"text\" value=\"in kWh:\" id=\"Annual_Production\" name=\"Annual_Production\" size=\"10\" required>"+
                                  "<br><label>CO2 avoided</label>"+"      <input type=\"text\" value=\"in kWh:\" name=\"CO2\" id=\"CO2\" size=\"10\" required>"+
                                  "<br><label>Reimbursement</label>"+"      <input type=\"text\" value=\"in euro:\" id=\"Reimbursement\" name=\"Reimbursement\" size=\"8\" required>"+
                                  "<br><label>System Panel Modules</label>"+"     <input type=\"text\" value=\"Enter Panel Modules:\" id=\"Panel_Modules\" name=\"Panel_Modules\" size=\"15\" required>"+
                                  "<br><label>Azimuth Angle</label>"+"          <input type=\"text\" value=\"Enter azimuth:\" id=\"Azimuth\" name=\"Azimuth\" size=\"12\" required>"+
                                  "<br><label>Inclination Angle</label>"+"       <input type=\"text\" value=\"Enter Inclination Angle:\" id=\"Inclination_Angle\" name=\"Inclination_Angle\" size=\"20\" required>"+
                                  "<br><label>Communication</label>"+"       <input type=\"text\" value=\"Enter Communication:\" id=\"Communication\" name=\"Communication\" size=\"15\" required>"+
                                  "<br><label>Inverter</label>"+"      <input type=\"text\" value=\"Enter Inverter:\" id=\"Inverter\" name=\"Inverter\" size=\"15\" required>"+
                                  "<br><label>Sensors</label>"+"      <input type=\"text\" value=\"Enter Sensors:\"id=\"Sensors\" name=\"Sensors\" size=\"10\" required>"+
